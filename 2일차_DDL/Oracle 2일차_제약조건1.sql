CREATE TABLE USER_NO_CONSTRANIT (
    USER_NO NUMBER,
    USER_ID VARCHAR2(20),
...
SELECT * FROM USER_NO_CONSTRANIT;
-- 1. khuser01, pass01, 일용자, 남, 010234567, khuser01@gmail.com

INSERT INTO USER_NO_CONSTRANIT
VALUES (1, 'khuser01', 'pss01', '일용자', '남', '01028227373', 'khuser01gmail.com');
COMMIT;
ROLLBACK;
...
INSERT INTO USER_UNIQUE
VALUES(1, 'khuser02', 'pass01', '일용자', null, null, null);
...
CREATE TABLE USER_CHECK (
    ...
    USER_PWD VARCHAR2(30) NOT NULL,
    USER_NAME VARCHAR2(30) NOT NULL,
    USER_GENDER VARCHAR(10) CHECK(USER_GENDER IN('M', 'F')),
    USER_PHONE VARCHAR2(30),
    USR_EMAIL VARCHAR2(50)
);
...
-- PRIMARY KEY: 중복안되고 NULL도 안됨, 유일한 값
...
VALUES(1, 'khuser01', 'pass01', '일용자', 'M', '01098765432', 'khuser01@gmail.com', '24/06/14');
INSERT INTO USER_DEFAULT
VALUES(2, 'khuser02', 'pass02', '이용자', 'M', '01098765432', 'khuser02@gmail.com', DEFAULT);
INSERT INTO USER_DEFAULT
VALUES(3, 'khuser03', 'pass03', '삼용자', 'M', '01098765432', 'khuser03@gmail.com', SYSDATE);
...
-- 2. UNIQUE : 중복이 되지 않게함
-- 3. PRIMARRY KEY : 중복, NULL 이 되지 않게함
...
CREATE TABLE USER_FOREIGN_KEY(
    ...
    USER_EMAIL VARCHAR2(50),
    USER_DATE DATE DEFAULT SYSDATE,
    GRADE_CODE NUMBER REFERENCES USER_GRADE(GRADE_CODE) ON DELETE SET NULL --CASCADE
);
-- USER_FOREIGN_KEY에 있는 GRADE_CODE는 USER_GRADE의 GRADE_CODE가 가지고 있는 10, 20, 30만 넣을 수 있어요
-- 10, 20, 30외에 40은 불가능 50도 불가능
SELECT * FROM USER_FOREIGN_KEY;
DELETE FROM USER_FOREIGN_KEY;
DROP TABLE USER_FOREIGN_KEY;
INSERT INTO USER_FOREIGN_KEY
VALUES(1, 'khuser01', 'psss01', '일용자', 'M', NULL, NULL, DEFAULT, 10);
INSERT INTO USER_FOREIGN_KEY
VALUES(2, 'khuser02', 'psss02', '이용자', 'M', NULL, NULL, DEFAULT, 20);
INSERT INTO USER_FOREIGN_KEY
VALUES(3, 'khuser03', 'psss03', '삼용자', 'M', NULL, NULL, DEFAULT, 30);
INSERT INTO USER_FOREIGN_KEY
VALUES(4, 'khuser04', 'psss04', '사용자', 'M', NULL, NULL, DEFAULT, 40);
UPDATE USER_FOREIGN_KEY
SET GRADE_CODE = null WHERE USER_ID = 'khuser04';
DELETE FROM USER_FOREGIN_KEY WHERE GRADE_CODE = 40;
DELETE FROM USER_GRADE WHERE GRADE_CODE = 40;

-- 테이블명 : SHOP_MEMBER
-- 저장해야할 데이터 : 1, khuser01, pass01, 일용자, M, 01022223333, khuser01@gmail.com
...
VALUES(1, 'khuser01', 'pass01', '일용자', 'M','01022223333', 'khuser01@gmail.com');
DELETE FROM SHOP_MEMBER WHERE USER_ID = 'khuser01';
INSERT INTO SHOP_MEMBER
VALUES(2, 'khuser02', 'pass02', '이용자', 'M','01022223333', 'khuser02@gmail.com');
...
-- khuser01, khuser02 등...만 넣을 수 있엉요
...
-- 외래키 FOREIGN KEY
-- 자식 테이블에서 부모 테이블이 가지고 있는 컬럼의 필드값으로만 INSERT하도록 하는것
-- 참조 무결성을 보장하는 제약조건임.
-- 외래키 설정방법
