...
-- ex1) USER_FOREIGN_KEY 테이블에 USER_DATE DATE 컬럼을 추가해주세요
-- ex2) USER_FOREIGN_KEY 테이블에 USER_DATE DATE 컬럼을 삭제해주세요
-- ex3) USER_FOREIGN_KEY 테이블에 USER_DATE 컬럼의 자료형을 VARCHAR2(10)으로 바꿔주세요
-- ex4) USER_FOREIGN_KEY 테이블에 USER_DATE DATE 컬럼의 이름을 REG_DATE로 변경해주세요
